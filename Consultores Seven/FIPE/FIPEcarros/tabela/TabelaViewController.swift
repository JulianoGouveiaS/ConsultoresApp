...
class TabelaViewController: UIViewController {
    ...
    func CarregaTabela() {
        ...
        print("id: \(self.id!) modelo: \(self.modelo!) codigo: \(self.codigo!)")
        ...
        DispatchQueue.main.asyncAfter(deadline: .now()+1) {
            ...
            self.alamofireManager!.request(URL(string: "https://www.sevenprotecaoveicular.com.br/Api/Recupemarca/carros/\(self.id!)/\(self.modelo!)/\(self.codigo!)")!, method: .get, parameters: nil, encoding: URLEncoding.default ).responseJSON { (response) in
                ...
                case .success(let value):
                    ...
                    print("json[tabela].stringValue: \(json["tabela"].stringValue)")
                    
                    print("self.Convertetabela(tabelaApi: json[tabela].stringValue): \(self.Convertetabela(tabelaApi: json["tabela"].stringValue))")
                ...
                case .failure(let error):
                    ...
                    if error._code == NSURLErrorTimedOut {
                        ...
                        self.CriarAlerta(tituloAlerta: "Oops!", mensagemAlerta: "Erro em captar as informações do veículo!", acaoAlerta: "Okay", erroRecebido: "\(error)")
                    }
                } //SWITCH
            } //RESPONSE JSON
        }//acao carregamento
        
    } //FUNC  nome nometabela e modelo
    ...
    @IBAction func pct30Click(_ sender: Any) {
        if self.id_tabela != 0{
            if self.id_tabela != 3 {
                ...
                if pacote_premio30Switch.isSelected == true{
