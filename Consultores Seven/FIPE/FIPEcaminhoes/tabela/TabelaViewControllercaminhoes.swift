...
class TabelaViewControllercaminhoes: UIViewController {
    ...
    func CarregaTabela() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now()+1) {
            ...
            self.alamofireManager!.request(URL(string: "https://www.sevenprotecaoveicular.com.br/Api/Recupemarca/motos/\(self.codigo!)/\(self.modelo!)/\(self.id!)")!, method: .get, parameters: nil, encoding: URLEncoding.default ).responseJSON { (response) in
    ...
    @IBAction func saveButt(sender: AnyObject) {
        ...
        CriarAlertaSemErro(tituloAlerta: "Sucesso", mensagemAlerta: "Simulação salva na galeria de fotos", acaoAlerta: "OK")
    }
