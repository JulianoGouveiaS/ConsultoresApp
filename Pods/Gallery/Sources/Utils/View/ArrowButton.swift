...
class ArrowButton: UIButton {
  ...
  override var isHighlighted: Bool {
    didSet {
      label.textColor = isHighlighted ? UIColor(red: 0, green: 26, blue: 94, alpha: 1) : Config.Grid.ArrowButton.tintColor
      arrow.tintColor = isHighlighted ? UIColor(red: 0, green: 26, blue: 94, alpha: 1) : Config.Grid.ArrowButton.tintColor
    }
  }
}
